...
from .validators import ValidationReport, validate_candidate_set, validate_question_plan
...
class ScientificProblemCompiler:
    def __init__(self, provider: Provider, domain_loader: DomainPackLoader | None = None) -> None:
    ...
    def compile(self, request: str, domain: str) -> CompilationResult:
        ...
        reports = tuple(validate_question_plan(plan, pack.capabilities) for plan in plans)
